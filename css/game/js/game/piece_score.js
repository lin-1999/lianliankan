...
Piece.prototype = {
    ...
    changeScore: function() {
       this.game.thisTime = this.game.time
            //console.log(this.game.lastTime)
            //console.log(this.thisTime - this.lastTime)
        if (this.game.lastTime != 0) {
            if (this.game.thisTime - this.game.lastTime <= 3) {
                this.game.score1 += 100;
            } else {
                this.game.score1 = 100;
            }
            this.game.lastTime = this.game.thisTime;
        } else if (this.game.lastTime == 0) {
            this.game.lastTime = this.game.thisTime;
        }

        this.game.score += this.game.score1;
